import {
  ...
  ɵfirebaseAppFactory,
  ɵlazySDKProxy
} from "./chunk-3XNGHV4A.js";
import {
  firebase
} from "./chunk-B4EYLBCL.js";
import {
  FirebaseApp
} from "./chunk-66D5PIWX.js";
import {
  VERSION,
...
import {
  ...
  registerVersion,
  uuidv4
} from "./chunk-EXZEJ7NY.js";
import {
  isPlatformServer
} from "./chunk-CCUT3PBZ.js";
import {
  Inject,
  Injectable,
  InjectionToken,
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name2, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-ILNUUWW3.js"))), map(() => ɵfirebaseAppFactory(options, zone, name2)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
...
@firebase/app-check/dist/esm/index.esm2017.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-F5I25NWN.js.map
